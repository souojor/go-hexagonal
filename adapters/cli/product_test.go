...
import (
	...
	"github.com/souojor/go-hexagonal/adapters/cli"
	mock_application "github.com/souojor/go-hexagonal/application/mocks"
...
func TestRun(t *testing.T) {
	...
	resultExpected := fmt.Sprintf("Product ID %s whit the name %s has been created with the price %f and status %s",
